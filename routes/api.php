...
Route::middleware([])->group(function () {
    ...
    Route::prefix('shipping_fee')->group(function () {
        ...
        Route::post('/store', [ShippingFeeController::class,'store']);
        Route::put('/update/{id}', [ShippingFeeController::class,'update']);
    ...
    Route::prefix('static_info')->group(function () {
        ...
        Route::post('/store', [StaticInfoController::class,'store']);
        Route::put('/update/{id}', [StaticInfoController::class,'update']);
